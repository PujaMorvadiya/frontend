        ...
        <div className="">
          {!isEditing ? (
            <div className="flex flex-row gap-2">
              {props.showBackButton && (
                <Button
                  ...
                  onClickHandler={props.customHandleBack}
                >
            ...
            <div className="flex gap-4 items-center">
              <input
                ref={inputRef}
                className="text-lg font-semibold text-dark truncate border border-solid border-LightWood rounded px-1 min-h-9"
                type="text"
                value={props.value}
              ...
              <div className="">
                <Button
                  className="w-8 h-8 bg-LightWood flex justify-center items-center rounded active:scale-90"
