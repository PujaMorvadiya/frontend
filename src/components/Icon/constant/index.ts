...
import ASLLiveAssesment from '../assets/ASLLiveAssesment';
import ASLMiniLesson from '../assets/ASLMiniLesson';
import ASLMiniLesson2 from '../assets/ASLMiniLesson2';
import Ban from '../assets/Ban';
import BarChart from '../assets/BarChart';
import BlockIcon from '../assets/BlockIcon';
import BookDataNotFound from '../assets/BookDataNotFound';
...
import CheckListRounded from '../assets/CheckListRounded';
import CheckRound from '../assets/CheckRound';
import CheckZigzag from '../assets/CheckZigzag';
import ChevronLeft from '../assets/ChevronLeft';
import ChevronRight from '../assets/ChevronRight';
import Clock from '../assets/Clock';
import ClockDataNotFound from '../assets/ClockDataNotFound';
import ClockRound from '../assets/ClockRound';
import CommonWordSearch from '../assets/CommonWordSearch';
import Community from '../assets/Community';
import CommunityDataNotFound from '../assets/CommunityDataNotFound';
import CopyFile from '../assets/CopyFile';
import CopyIcon from '../assets/CopyIcon';
import CourseCategory from '../assets/CourseCategory';
import CourseView from '../assets/CourseView';
import CrossIcon from '../assets/CrossIcon';
import DashboardIcon from '../assets/DashboardIcon';
import DBBuilding from '../assets/DBBuilding';
import DBFolder from '../assets/DBFolder';
import DBOrg from '../assets/DBOrg';
import DBSubscription from '../assets/DBSubscription';
import DBTotalUser from '../assets/DBTotalUser';
...
import Filter2 from '../assets/Filter2';
...
import InstagramColor from '../assets/InstagramColor';
...
import NoCommunity from '../assets/NoCommunity';
import NoSubscriptions from '../assets/NoSubscriptions';
import NoSubscriptionsNew from '../assets/NoSubscriptionsNew';
import NoteBook from '../assets/NoteBook';
import NoteBookmark from '../assets/NoteBookmark';
import NoteLog from '../assets/NoteLog';
import NoteRounded from '../assets/NoteRounded';
...
import PaymentAmericanExpress from '../assets/PaymentAmericanExpress';
import PaymentCartesBancaires from '../assets/PaymentCartesBancaires';
import PaymentDinersClub from '../assets/PaymentDinersClub';
import PaymentDiscover from '../assets/PaymentDiscover';
import PaymentEftpos from '../assets/PaymentEftpos';
import PaymentElo from '../assets/PaymentElo';
import PaymentJCB from '../assets/PaymentJCB';
import PaymentMaestro from '../assets/PaymentMaestro';
import PaymentMasterCard from '../assets/PaymentMasterCard';
import PaymentMir from '../assets/PaymentMir';
import PaymentRuPay from '../assets/PaymentRuPay';
import PaymentUnionpay from '../assets/PaymentUnionpay';
import PaymentVisa from '../assets/PaymentVisa';
...
import ReceiptDataNotFound from '../assets/ReceiptDataNotFound';
import ReceptiveCourses from '../assets/ReceptiveCourses';
import RedExclamationMarkIcon from '../assets/RedExclamationMarkIcon';
import ReferUser from '../assets/ReferUserIcon';
...
import ShareIcon2 from '../assets/ShareIcon2';
...
import ThreeMoreDotsFill from '../assets/ThreeMoreDotsFill';
...
import Unpublished from '../assets/Unpublished';
import UploadSimple from '../assets/UploadSimple';
...
import WordView from '../assets/WordView';
...
const iconComponents: {
  ...
  threeMoreDotsFill: ThreeMoreDotsFill,
  blockIcon: BlockIcon,
  reply: Reply,
  ...
  zoomIcon: ZoomIcon,
  dBTotalUser: DBTotalUser,
  dBBuilding: DBBuilding,
  dBOrg: DBOrg,
  dBFolder: DBFolder,
  dBSubscription: DBSubscription,
  filter2: Filter2,
  paymentVisa: PaymentVisa,
  paymentMasterCard: PaymentMasterCard,
  paymentAmericanExpress: PaymentAmericanExpress,
  paymentCartesBancaires: PaymentCartesBancaires,
  paymentDinersClub: PaymentDinersClub,
  paymentDiscover: PaymentDiscover,
  paymentEftpos: PaymentEftpos,
  paymentElo: PaymentElo,
  paymentJCB: PaymentJCB,
  paymentMaestro: PaymentMaestro,
  paymentMir: PaymentMir,
  paymentUnionpay: PaymentUnionpay,
  paymentRuPay: PaymentRuPay,
  ...
  commonWordSearch: CommonWordSearch,
  shareArrow: ShareArrow,
  receptiveCourses: ReceptiveCourses,
  aSLMiniLesson2: ASLMiniLesson2,
  aSLLiveAssesment: ASLLiveAssesment,
  referUser: ReferUser,
  ...
  noSubscriptionsNew: NoSubscriptionsNew,
  communityDataNotFound: CommunityDataNotFound,
  bookDataNotFound: BookDataNotFound,
  receiptDataNotFound: ReceiptDataNotFound,
  clockDataNotFound: ClockDataNotFound,
};
