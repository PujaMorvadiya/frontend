...
export const zipCodeRegexError = Object.freeze('Must contain 5 to 10 digit number');
...
export enum PasswordError {
  ...
  minLengthReq = 'At least 8 characters',
...
export const UserSchemaErrorMessage = Object.freeze({
  ...
  birth_date: BasicErrorMessage.birth_date,
